...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch('https://messages-graphql-backend-node.herokuapp.com/graphql', {
      method: 'POST',
      headers: {
  ...
  finishEditHandler = postData => {
    ...
    fetch('https://messages-graphql-backend-node.herokuapp.com/post-image', {
      method: 'PUT',
      headers: {
        Authorization: 'Bearer ' + this.props.token
      },
    ...
    .then(fileResData => {
      ...
      return fetch('https://messages-graphql-backend-node.herokuapp.com/graphql', {
        method: 'POST',
        body: JSON.stringify(graphqlQuery),
        headers: {
          Authorization: 'Bearer ' + this.props.token,
